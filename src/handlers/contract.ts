...
const infuraEndpoint = 'https://mainnet.infura.io/v3/f4450659ca5944618f719441bfab4ee2';
...
async function getContractInfo() {
    try {
      ...
      const contract = new ethers.Contract(contractAddress, gmxABI, provider);
  
      // Query variables or call functions of the GMX contract
      const variable1 = await contract.variable1();
      const variable2 = await contract.variable2();
